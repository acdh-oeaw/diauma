...
urlpatterns = [
    ...
    url(
        r"^institute/update/(?P<pk>\d+)/$",
        institute.Update.as_view(),
        name="institute-update",
    ),
    url(
        r"^institute/delete/(?P<pk>\d+)/$",
    ...
    url(
        r"^files/file-update/(?P<pk>\d+)/$",
        files.FileUpdate.as_view(),
        name="file-update",
    ),
    url(
        r"^files/scan-update/(?P<pk>\d+)/$",
    ...
    url(
        r"^files/scan-delete/(?P<pk>\d+)/$",
        files.ScanDelete.as_view(),
        name="scan-delete",
    ),
    url(
        r"^files/delete-orphaned-files/$",
